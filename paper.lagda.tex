...
The operator \AgdaBound{~_} revert the interval. If the interval \AgdaBound{i} goes from
\AgdaBound{i0} to \AgdaBound{i1}, the interval \AgdaBound{~ i} goes from \AgdaBound{i1} to \AgdaBound{i0}.
